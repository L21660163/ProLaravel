<x-app-layout>
    <!-- Componente de encabezado: Título principal de la página -->
    <x-slot name="header">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-8">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <!-- Botones de filtros por estado de los proyectos -->
                    <div class="flex items-center justify-between space-x-4">
                        ...
                        <!-- Campo de búsqueda para filtrar proyectos -->
            ...
            <!-- Contenedor dinámico para mostrar proyectos filtrados -->
    ...
    <!-- Script con funciones interactivas -->
    <script>
        /**
         * Cambia el estilo del botón activo y muestra la sección correspondiente.
        ...
        /**
         * Muestra contenido dinámico basado en la sección seleccionada.
        ...
        /**
         * Filtra los proyectos según la carrera seleccionada.
         */
        ...
        /**
         * Busca un proyecto por nombre o palabra clave.
         */
