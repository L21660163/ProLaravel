...
class JefeAcademiaController extends Controller
{
    public function index()
    {
        ...
        $proyectosRevision = Proyecto::where('estado', 'revision')->get();
        $proyectosEvaluacion = Proyecto::where('estado', 'evaluacion')->get();
        $proyectosVigentes = Proyecto::where('estado', 'vigente')->get();
        $proyectosFinalizados = Proyecto::where('estado', 'finalizado')->get();
    ...
    {
        $proyecto = Proyecto::findOrFail($id); // Buscar el proyecto por ID
