<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            {{ __('Aquí puedes gestionar los roles, asignarles permisos, editarlos o eliminarlos.') }}
        </p>
    </header>
...
<div id="editRoleModal" class="hidden fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center">
